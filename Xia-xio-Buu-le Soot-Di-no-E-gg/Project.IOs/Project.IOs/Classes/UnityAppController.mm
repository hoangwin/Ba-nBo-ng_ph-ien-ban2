...
//banner : ca-app-pub-7342700401302892/3593969369
// full : ca-app-pub-7342700401302892/5070702560
-(void) showAdmob
{    
    bannerView_ = [[GADBannerView alloc] initWithAdSize:kGADAdSizeBanner];//here
    bannerView_.adUnitID = @"ca-app-pub-7342700401302892/2991866961";//admob caogiaqn
...
-(void) showAdmobFullAds
{
    ...
    interstitial_.adUnitID = @"ca-app-pub-7342700401302892/7089905367";
...
extern "C" {//here
	...
	void NaticeShowAdsBanner (const char* phoneNumber, const char* bodyText)// chua dung vi dung thang trong 
	{
      ...
      //  [GetAppController() showAdmobFullAds];
		...
		void NaticeShowAdsFull(const char* phoneNumber, const char* bodyText)
	{
